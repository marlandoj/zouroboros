...
type SelfhealModule = typeof import('zouroboros-selfheal');
...
export const healCommand = new Command('heal')
  ...
  .addCommand(
    new Command('introspect')
      ...
      .action(async (options) => {
        const { introspect } = await loadOptional<SelfhealModule>('zouroboros-selfheal', 'heal introspect');
  ...
  .addCommand(
    new Command('prescribe')
      ...
      .action(async (options) => {
        ...
        const { prescribe } = await loadOptional<SelfhealModule>('zouroboros-selfheal', 'heal prescribe');
  ...
  .addCommand(
    new Command('evolve')
      ...
      .action(async (options) => {
        console.log(chalk.cyan('\n🧬 Executing evolution...\n'));
        const { evolve } = await loadOptional<SelfhealModule>('zouroboros-selfheal', 'heal evolve');
