  ...
  private defaultObjective(): CompositeObjective {
    return {
      targets: [
        ...
        // Wiring Health IS an optimization target (wired/declared capabilities).
        // Eval-Integrity is intentionally OMITTED: it is a display-only anti-Goodhart
        // tripwire (collector weight 0) and adding it here would let the loop game it.
        { metricName: 'Wiring Health', weight: 0.12, direction: 'maximize', threshold: 0.80 },
      ],
