...
description: "Progressive 3-stage evaluation pipeline: mechanical checks, semantic verification against acceptance criteria, and multi-model consensus for high-stakes decisions."
