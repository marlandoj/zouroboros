...
description: Socratic interview skill that clarifies requirements before any major build task and produces an immutable seed spec with acceptance criteria and ontology.
