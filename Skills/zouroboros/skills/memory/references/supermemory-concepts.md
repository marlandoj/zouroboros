...
- **Hosted memory service**: Supermemory is a managed product. We run our own memory layer (local SQLite + self-managed pipeline), calling OpenAI only for inference and embeddings.
