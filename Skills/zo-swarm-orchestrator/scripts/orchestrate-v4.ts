 ...
 * - Queries shared combo recommendations for live model selection
 ...
 * - Falls back to static tier→combo mapping when live combo data is unavailable
...
interface Task {
  ...
  // v4.7: Per-task model/combo override — uses this combo instead of the tier default.
...
// ============================================================================
// v4.7: TIERED MODEL ROUTING — maps complexity to shared swarm combos
// v4.8: DYNAMIC MODEL ROUTING — queries live combo recommendations
// ============================================================================
...
// Combo cache: avoids repeated combo lookups on every task in a DAG wave
...
// v4.10: API fallback health state (disabled by default)
